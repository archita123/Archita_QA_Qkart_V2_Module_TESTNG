...
public class Home {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            driver.findElement(By.xpath("//*[@id='root']/div/div/div[1]/div[2]/div")).clear();

            driver.findElement(By.xpath("//*[@id='root']/div/div/div[1]/div[2]/div"))
                    .sendKeys("Gesundheit");
            driver.findElement(By.xpath("//*[@id='root]/div/div/div[1]/div[2]/div")).click();
            driver.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div/div[2]/div/h4"))
                    .isDisplayed();

            // = true if the element is *displayed* else set status = fals
            return true;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             * matching productName Click on the "ADD TO CART" button for that element Return true
             * if these operations succeeds
             */
    ...
    public Boolean clickCheckout() {
        ...
        try {
            ...
            // driver.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[4]/button")).click();
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            List<WebElement> cartContents = driver.findElementsByClassName("css-zgtx0t");
            ...
            for (int i = 1; i <= cartContents.size(); i++) {
                ...
                if (productName
                        .contains(driver
                                ...
                                .getText())) {
                    {
                        currQty = Integer.valueOf(cartContents.get(i - 1)
                    ...
                    while (currQty != quantity) {
                        if (currQty < quantity) {
                            ...
                            cartContents.get(i - 1).findElements(By.tagName("button")).get(1)
                                    .click();

                            wait.until(ExpectedConditions.textToBePresentInElement(
                                    cartContents.get(i - 1).findElement(By.className("css-olyig7")),
                                    String.valueOf(currQty + 1)));

                            Thread.sleep(2000);
                        } else {
                            cartContents.get(i - 1).findElements(By.tagName("button")).get(0)
                                    .click();
                            Thread.sleep(2000);
                        }
                        currQty = Integer.valueOf(cartContents.get(i - 1)
            ...
            // driver.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/button[1]/span")).click();
